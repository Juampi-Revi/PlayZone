            ...
            <div className="order-2 lg:order-1">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  {[
                    { label: 'Canchas Verificadas', value: '500+', icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" strokeWidth={2}/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3c2.5 2 2.5 6 0 8s-2.5 6 0 8M3 12c2 2.5 6 2.5 8 0s6-2.5 8 0"/></svg>, color: 'text-emerald-600' },
