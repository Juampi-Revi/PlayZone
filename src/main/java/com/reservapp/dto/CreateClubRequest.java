...
public class CreateClubRequest {
    ...
    public CreateClubRequest(String nombre, String descripcion, String direccion, String telefono, 
                           String email, String sitioWeb, String horarioAtencion, List<String> servicios,
                           String politicasCancelacion, String reglasGenerales, Long propietarioId) {
        this.nombre = nombre;
